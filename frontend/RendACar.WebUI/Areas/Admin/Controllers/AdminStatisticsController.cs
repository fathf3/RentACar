...
using RentACar.Dto.StatisticDtos;
...
namespace RentACar.WebUI.Areas.Admin.Controllers
{
    public class AdminStatisticsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            #region İstatistik12
            var responseMessage15 = await client.GetAsync("https://localhost:7290/api/Statistics/GetCarBrandAndModelByRentPriceDailyMax");
            ...
            #region İstatistik13
            var responseMessage16 = await client.GetAsync("https://localhost:7290/api/Statistics/GetCarBrandAndModelByRentPriceDailyMin");
