...
namespace RentACar.WebUI.ViewComponents.DashboardComponents
{
    public class AdminDashboardStatisticsComponentPartial : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            #region İstatistik3
            var responseMessage3 = await client.GetAsync("https://localhost:7290/api/Statistics/GetBrandCount");
            ...
            #region İstatistik4
            var responseMessage4 = await client.GetAsync("https://localhost:7290/api/Statistics/GetAvgRentPriceForDaily");
